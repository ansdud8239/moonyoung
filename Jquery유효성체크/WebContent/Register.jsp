...
<body>
	...
	<form onsubmit="return checkz()" method="post"
		action="mailto:szx0228@naver.com" enctype="text/plain">
		...
		<table align="center" border="3" cellspacing="0">
			...
			<tr>
				...
				<td colspan="4"><input type="text" name="id" maxlength="12"
					id="tbID"> 4~12자리의 영문 대소문자와 숫자로만 입력</td>
			</tr>

			<tr>
				<td>비밀번호:</td>
				<td colspan="4"><input type="password" maxlength="12"
					id="tbPwd"> 4~12자리의 영문 대소문자와 숫자로만 입력</td>
			</tr>
			<tr>
				<td>비밀번호확인:</td>
			...
			<tr>
				<td>주민등록번호:</td>
				<td colspan="4"><input type="text" name="jum" id="pnum">-<input
					type="password" name="jumin" id="nnum">예)123456789</td>
			</tr>
			...
			<tr>
				<td>관심분야:</td>
				<td colspan="3"><input type="checkbox" name="hobby[]"
					value="컴퓨터">컴퓨터 <input type="checkbox" name="hobby[]"
					value="인터넷">인터넷 <input type="checkbox" name="hobby[]"
					value="여행">여행 <input type="checkbox" name="hobby[]"
					value="영화감상">영화감상 <input type="checkbox" name="hobby[]"
					value="음악감상">음악감상</td>
			</tr>

			<tr>
				<td width="20" height="100">자기소개:</td>
				<td colspan="3"><textarea name="my_intro" id="intro" cols="50"
						rows="5"></textarea></td>
			</tr>
